...
def create_daksha_workflow() -> StateGraph:
    ...
    # Define edges
    # KYC ΓåÆ Onboarding (or END if KYC fails)
    ...
    # Feature Engineering ΓåÆ Compliance
    workflow.add_conditional_edges(
        "feature_engineering",
    ...
    # HITL Checkpoint ΓåÆ Compliance (or loop back to Onboarding)
    workflow.add_conditional_edges(
        "hitl_checkpoint",
    ...
    # Compliance ΓåÆ Router or Supervisor (or END if compliance fails)
    workflow.add_conditional_edges(
        "compliance",
    ...
    # Router ΓåÆ Underwriting (loan or insurance)
    workflow.add_conditional_edges(
        "router",
        route_after_router,
        {
    ...
    # Loan flow: Underwriting ΓåÆ Verification ΓåÆ Explanation
    ...
    # Insurance flow: Underwriting ΓåÆ Verification ΓåÆ Explanation ΓåÆ Supervisor
    ...
    # Supervisor ΓåÆ Finalize or Loopback
    workflow.add_conditional_edges(
        "supervisor",
